...
const img = (seed: string, category = 'vetements') => {
  ...
  return `https://placehold.co/800x800/${color}/FFFFFF?text=${label}`;
};
...
export const DEMO_SHOPS: Shop[] = [
  {
    ...
    name: 'Faso Fashion',
    description:
      "Boutique de vêtements tendance pour jeunes. Import et confection locale à Ouagadougou. Livraison rapide dans tout le Burkina.",
    logo_url: 'https://placehold.co/200x200/FF6B00/FFFFFF?text=FF',
    banner_url: 'https://placehold.co/1200x400/FF6B00/FFFFFF?text=Faso+Fashion',
  ...
  },
  {
    ...
    name: 'Karité Naturel',
    description:
      "Cosmétiques 100% naturels au beurre de karité. Savons, crèmes et baumes fabriqués à Bobo-Dioulasso.",
    logo_url: 'https://placehold.co/200x200/00A859/FFFFFF?text=KN',
    banner_url: 'https://placehold.co/1200x400/00A859/FFFFFF?text=Karit%C3%A9+Naturel',
  ...
  },
  {
    ...
    description:
      "Pâtisseries et plats faits maison. Commandez vos gâteaux d'anniversaire et plats de fête.",
    logo_url: 'https://placehold.co/200x200/FFC107/FFFFFF?text=DK',
    banner_url: 'https://placehold.co/1200x400/FFC107/FFFFFF?text=D%C3%A9lices+de+Koudougou',
  ...
  },
  {
    ...
    name: 'Artisanat Faso',
    description:
      "Sculptures, bijoux en bronze et objets décoratifs faits main par nos artisans.",
    logo_url: 'https://placehold.co/200x200/6B2D8E/FFFFFF?text=AF',
    banner_url: 'https://placehold.co/1200x400/6B2D8E/FFFFFF?text=Artisanat+Faso',
  ...
  },
  {
    ...
    name: 'Tech & Accés',
    description:
      "Accessoires téléphones, écouteurs, coques et chargeurs à petits prix.",
    logo_url: 'https://placehold.co/200x200/0DCAF0/FFFFFF?text=TA',
    banner_url: 'https://placehold.co/1200x400/0DCAF0/FFFFFF?text=Tech+%26+Acc%C3%A9s',
  ...
  },
  {
    ...
    description:
      "Maquillage, soins du visage et produits capillaires. Conseil personnalisé gratuit.",
    logo_url: 'https://placehold.co/200x200/FF8533/FFFFFF?text=BN',
    banner_url: 'https://placehold.co/1200x400/FF8533/FFFFFF?text=Beaut%C3%A9+Naturelle',
    category_id: 'beaute',
    city: 'Banfora',
...
export const DEMO_PRODUCT_VIDEOS: ProductVideo[] = [
  {
    ...
    source: 'tiktok',
    thumbnail_url: 'https://placehold.co/600x400/000000/FFFFFF?text=Video+TikTok',
    duration_sec: null,
    position: 0,
  ...
  },
  {
    ...
    source: 'youtube',
    thumbnail_url: 'https://placehold.co/600x400/FF0000/FFFFFF?text=Démonstration',
    duration_sec: null,
    position: 0,
  ...
  },
  {
    ...
    source: 'tiktok',
    thumbnail_url: 'https://placehold.co/600x400/6B2D8E/FFFFFF?text=Fabrication',
    duration_sec: null,
    position: 0,
...
export const DEMO_REVIEWS: Review[] = [
  { id: 'r1', user_id: 'demo-buyer', shop_id: 'shop-1', product_id: null, rating: 5, comment: 'Très bonne qualité, livraison rapide !', created_at: '2026-04-01T10:00:00Z' },
  { id: 'r2', user_id: 'demo-buyer', shop_id: 'shop-1', product_id: null, rating: 4, comment: 'Bon produit mais taille un peu petit.', created_at: '2026-04-05T10:00:00Z' },
  { id: 'r3', user_id: 'demo-buyer', shop_id: 'shop-2', product_id: null, rating: 5, comment: 'Le beurre de karité est parfait, peau douce.', created_at: '2026-04-10T10:00:00Z' },
  { id: 'r4', user_id: 'demo-buyer', shop_id: 'shop-3', product_id: null, rating: 5, comment: 'Le gâteau était délicieux et beau !', created_at: '2026-04-12T10:00:00Z' },
];
...
export const DEMO_DELIVERY_REQUESTS: (DeliveryRequest & {
...
})[] = [
  {
    ...
    payment: { id: 'dpay-1', delivery_id: 'deliv-1', amount: 1250, operator: 'orange_money', proof_image_url: 'https://placehold.co/400x300/FF7900/FFFFFF?text=OM+1250', status: 'validated', created_at: '2026-07-29T08:10:00Z', validated_at: '2026-07-29T08:20:00Z' },
  },
  {
    id: 'deliv-2',
    seller_id: 'demo-seller',
...
const SHARE_BASE_URL = 'https://boutikplus.app/s';
